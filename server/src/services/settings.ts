...
const DEFAULTS: AppSettings = { allowSignups: true, maintenanceMessage: '', maxGenerationsPerUserPerDay: 50, maxUploadMbPerUser: 500, housePostsPerDay: 2, paymentsEnabled: true, promotionsEnabled: true, platformFeePercent: 20, openaiManagedKeys: false, managedGenerationsPerUserPerDay: 10, managedImages: false };
